...
public class EventRegisterer {
	...
	public void registerGUIEvents(){
		...
		vars.voteShopMain = new GUI(9,
				ConvertColors.convertColors("&6&lPoint&8&lShop")[0], vars.handler);
		ItemStack kits = Item
				.newItemMeta(Material.DIAMOND_CHESTPLATE, "&a&l&oKits",
						"&b&l&oYou cannot buy kits ,&b&l&oout of order. You ,&b&l&omust upgrade your kits.");
		vars.voteShopMain.addButton(kits, 1, new Runnable() {
			@Override
			public void run() {
				// TODO Add voteShopKits
			}
		});
		ItemStack ranks = Item
				.newItemMeta(Material.NAME_TAG, "&5&l&oRanks",
						"&b&l&oYou cannot buy ranks ,&b&l&oout of order. You must ,&b&l&oupgrade your ranks.");
		vars.voteShopMain.addButton(ranks, 3, new Runnable() {
			@Override
			public void run() {
		...
		vars.voteShopMain.addButton(weapons, 7, new Runnable() {
			@Override
			public void run() {
